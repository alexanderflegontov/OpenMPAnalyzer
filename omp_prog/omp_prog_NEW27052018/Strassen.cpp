...
int main(int argc, char** argv)
{
	...
	cout << "Enter num of threads and the degree of two:" << endl;
	//cin >> k >> num_th;
	k = 2;
	num_th = 2;
	if(argc > 2){
	...
	if(!(k>0)){
		std::cout <<"the degree of two should be > 0 " << std::endl;
		return 2;			
	}
	...
	cout << "Strassen algorithm time = " << TimeStrAlg << " sec"<< endl;
	cout << "Strassen parallel algorithm time = " << TimeStrPpAlg << " sec" << endl;
	cout << endl;
