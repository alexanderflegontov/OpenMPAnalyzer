 ...
 */
    ...
    class ThreadStat extends Group{
        ...
        private void AddMain(Section sec){
            if(oneMain == false){
                oneMain = true;
        ...
        private void AddParallel(Section sec){
            ...
            statTableData.AddParallel(sec);
        }
                
        private void AddPayload(Section sec){
            ...
            statTableData.AddPayload(threadId, sec);
        }
        ...
        public void AddSection(Section sec){
            if(!sec.isValid()){
                System.out.println("AddSection(): Incorrect TIME !!!");
                // If the new section is invalid then we think all INFOs are invalid.   
                isValidThreadInfo = false;
                return;
            }
