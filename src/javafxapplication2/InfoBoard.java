...
public class InfoBoard extends Group{    
    ...
    public void ShowStatForAllThreadWithFullClear(){ //ShowStatForAllThreadWithFullClear
        ...
        double sharedParallelTime = mainThreadInfo.GetTimeParallel();
        this.UpdateInfoMainCircle(mainThreadInfo.GetTimeOfWork(), mainThreadInfo.GetTimePayload(), mainThreadInfo.GetTimeParallel());
    ...
    private void UpdateInfoMainCircle(double overheadTime, double payloadTime, double parallelTime){
    ...
    public class CircleInfo extends VBox {
        ...
        public void UpdateCI(double parallelTime, double overheadTime){
            System.out.println("parallelTime="+parallelTime);
            System.out.println("overheadTime="+overheadTime);
            arcPart.setLength(COEF_ARC_PART_LENGTH*((parallelTime / overheadTime)*100.0));
            timeLabelPart.setText(PercentageValue(parallelTime, overheadTime));
            timeLabelAll.setText(TimeToString(overheadTime)); ///
